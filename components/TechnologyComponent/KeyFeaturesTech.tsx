...
const KeyFeaturesTech = ({ techId }: { techId: string }) => {
  ...
  const titlepart1 = t(`${techId}.titlepart1`);
  const titlepart2 = t(`${techId}.titlepart2`);
  const titlepart3 = t(`${techId}.titlepart3`);
              ...
              <ul className="space-y-4">
                {feature.items.map((item, itemIndex) => (
                  <li key={itemIndex} className="flex gap-3">
                    ...
                    <div className="text-[#667085] md:text-sm text-xs">
